...
import { flip, offset, useFloating, useHover, useInteractions, shift, useMergeRefs, FloatingPortal, safePolygon } from "@floating-ui/react"
    ...
    return <>
        ...
        <FloatingPortal>
            {isOpen && <NavListFolderModalElement ref={refs.setFloating} style={floatingStyles} {...getFloatingProps()}>
                <NavDragDropContainer displayingItems={items} folderPath={folderPath} />
