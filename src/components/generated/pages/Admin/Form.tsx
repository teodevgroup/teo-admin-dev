...
import { teo, TeoError, Admin, AdminCreateInput, AdminUpdateInput } from '../../../../lib/generated/teo'
...
const AdminForm = ({ item }: PageProps) => {
    ...
    const [formPreferences, setFormPreferences] = useModelAdminFormPreferences()
