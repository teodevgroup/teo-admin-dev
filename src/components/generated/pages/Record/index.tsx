...
import RecordRecords from './Records'
import RecordDashboard from './Dashboard'
import { useTranslation } from 'react-i18next'

const RecordPage = ({ item }: PageProps) => {
    ...
    return <Page>
        ...
        <Main>
            {item.variant === "records" ? <RecordRecords item={item} /> : <RecordDashboard item={item} />}
        </Main>
    </Page>
}
