...
import NullableRecordRecords from './Records'
import NullableRecordDashboard from './Dashboard'
import { useTranslation } from 'react-i18next'

const NullableRecordPage = ({ item }: PageProps) => {
    ...
    return <Page>
        ...
        <Main>
            {item.variant === "records" ? <NullableRecordRecords item={item} /> : <NullableRecordDashboard item={item} />}
        </Main>
    </Page>
}

export default NullableRecordPage